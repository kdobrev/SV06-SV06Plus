 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  ((X_CURRENT * 65 + 50) / 100) // (mA) RMS current for homing. (Typically lower than *_CURRENT.)
    ...
    #define Y_CURRENT_HOME  ((Y_CURRENT * 65 + 50) / 100)
    ...
    #define Z_CURRENT_HOME  ((Z_CURRENT * 80 + 50) / 100)
